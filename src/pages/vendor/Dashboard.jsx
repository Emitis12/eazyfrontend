  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <VendorSidebar
        ...
        onActiveOrdersClick={() => activeOrders.length > 0 && setSelectedOrder(activeOrders[0])}
      />
      ...
      <div className="md:hidden bg-white p-3 shadow flex justify-between items-center">
        ...
        <Button
          label="Menu"
          onClick={() => document.querySelector("#vendor-sidebar")?.classList.toggle("hidden")}
          variant="outline"
        />
      </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => activeOrders.length > 0 && setSelectedOrder(activeOrders[0])}
              variant="primary"
            />
            <Button
              label="Chat"
      ...
      <main className="flex-1 p-4 sm:p-6 space-y-6">
        ...
        {selectedOrder && (
          ...
          >
            <div className="space-y-3">
              ...
              <p>
                <strong>Drop-off:</strong> {selectedOrder.deliveryAddress}
              </p>
              <p>
        ...
        {incomingOrder && (
          ...
          >
            <div className="space-y-3">
              <p>
                <strong>Customer:</strong> {incomingOrder.customerName}
              </p>
              <p>
                <strong>Pickup:</strong> {incomingOrder.pickupAddress}
              </p>
              <p>
                <strong>Drop-off:</strong> {incomingOrder.deliveryAddress}
              </p>
              <p>
                <strong>Status:</strong> {incomingOrder.status}
              </p>
              <div className="flex flex-col sm:flex-row gap-3 mt-3">
                <Button
                  label="Accept"
